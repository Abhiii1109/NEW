...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-16 bg-white sticky top-0 z-40 px-4 md:px-8">
        ...
        <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
          ...
          <div className="flex flex-col justify-center">
            <div className="hidden md:flex items-center gap-2 overflow-hidden">
              <span className="text-[10px] font-bold text-text-muted/60 uppercase tracking-widest shrink-0">
                HRM
              </span>
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-text-heading leading-none truncate max-w-[120px]">
                  {user?.name}
                </p>
