...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      <aside
        className={cn(
          "fixed left-0 top-0 h-screen bg-sidebar-bg flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 w-64",
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 scrollbar-hide">
          <div className="px-3 mb-2">
            <p className="text-[11px] font-bold text-sidebar-text/50 uppercase tracking-widest">
              Main Menu
            </p>
          </div>
