              ...
              <Card key={leave.id} className="flex flex-col md:flex-row md:items-center justify-between gap-6 group hover:border-primary transition-all">
                  <div className="flex items-start gap-4">
                      <div className="relative">
                        <img src={leave.avatar || `https://ui-avatars.com/api/?name=${leave.name}&background=0f172a&color=fff`} alt="" className="w-12 h-12 rounded-lg bg-slate-50" />
                      ...
                      <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            ...
                            <div className="flex items-center gap-1.5 text-[10px] text-primary font-bold bg-slate-50 px-2 py-0.5 rounded-md">
                                <Calendar size={10} className="text-slate-400" />
                                {leave.from} — {leave.to}
                            </div>
                          </div>
                          {leave.remarks && (
                            <p className="text-xs text-muted font-medium mt-3 italic leading-relaxed border-l-2 pl-3">“{leave.remarks}”</p>
                          )}
                      </div>
                  </div>
